...
export const LISTENER_RANKS = [
  ...
  { level: 2, name: 'Singer da Doccia', minScore: 500, color: 'text-slate-300', icon: '🚿' },
  { level: 3, name: 'Singer da Luna Piena', minScore: 1500, color: 'text-cyan-400', icon: '🌕' },
  { level: 4, name: 'Cacciatore di Hit', minScore: 3500, color: 'text-teal-400', icon: '🎵' },
  { level: 5, name: 'DJ del Venerdì Sera', minScore: 7500, color: 'text-emerald-400', icon: '📻' },
  { level: 6, name: 'Ascoltatore da Bus', minScore: 15000, color: 'text-green-400', icon: '🎧' },
  { level: 7, name: 'Orecchio Fino', minScore: 25000, color: 'text-lime-400', icon: '⚡' },
  { level: 8, name: 'Chitarrista da Falò', minScore: 40000, color: 'text-yellow-400', icon: '🎸' },
  { level: 9, name: 'Urla-in-Macchina Pro', minScore: 60000, color: 'text-amber-400', icon: '🚗' },
  { level: 10, name: 'Music Buff', minScore: 90000, color: 'text-orange-400', icon: '🔥' },
  { level: 11, name: 'Re del Karaoke', minScore: 130000, color: 'text-rose-400', icon: '🎤' },
  { level: 12, name: 'Tamburellatore da Scrivania', minScore: 180000, color: 'text-pink-400', icon: '🥁' },
  { level: 13, name: 'Producer da Salotto', minScore: 240000, color: 'text-fuchsia-400', icon: '🎛️' },
  { level: 14, name: 'Vinyl Wizard', minScore: 310000, color: 'text-purple-400', icon: '👑' },
  { level: 15, name: 'Enciclopedia Vivente', minScore: 400000, color: 'text-violet-400', icon: '🔮' },
  { level: 16, name: 'Audio Virtuoso', minScore: 500000, color: 'text-indigo-400', icon: '🌟' },
  { level: 17, name: 'Rockstar Prodigy', minScore: 650000, color: 'text-blue-400', icon: '💫' },
  { level: 18, name: 'Sonic Maestro', minScore: 850000, color: 'text-cyan-300', icon: '🚀' },
  { level: 19, name: 'Shazam Umano', minScore: 1100000, color: 'text-emerald-300', icon: '🌌' },
  { level: 20, name: 'Legend of Sound', minScore: 1400000, color: 'text-yellow-300', icon: '🏆' },
];
