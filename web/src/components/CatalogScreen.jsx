            ...
            <div className="flex items-center gap-2.5 flex-wrap">
              <h2 className="font-display font-black text-xl sm:text-2xl tracking-wide bg-gradient-to-r from-white via-rose-200 to-amber-300 bg-clip-text text-transparent flex items-center gap-2.5">
                ...
                <svg className="w-6 h-6 shrink-0 drop-shadow-md" viewBox="0 0 24 24">
                  <path d="M12 2C6.48 2 2 6.48 2 12c0 3.24 1.54 6.11 3.92 7.94.16.12.26.32.27.52l.14 2.04c.06.82.72 1.5 1.54 1.5h8.26c.82 0 1.48-.68 1.54-1.5l.14-2.04c.01-.2.11-.4.27-.52C20.46 18.11 22 15.24 22 12c0-5.52-4.48-10-10-10z" fill="url(#skullGradWeb)" />
                  ...
                  <defs>
                    <linearGradient id="skullGradWeb" x1="2" y1="2" x2="22" y2="24" gradientUnits="userSpaceOnUse">
